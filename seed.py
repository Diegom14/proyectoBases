...
sql =""" 
INSERT INTO personas (rut, dv, cantidad_choques, edad, nombre, direccion, comuna) values (1, '1', 1, 27, 'JUAN SOTO', 'ejercito 4', 'comuna1');
 
INSERT INTO personas (rut, dv, cantidad_choques, edad, nombre, direccion, comuna) values (2, '2', 1, 23, 'ROBERTO DIAZ', 'ejercito 5', 'comuna2');

INSERT INTO personas (rut, dv, cantidad_choques, edad, nombre, direccion, comuna) values (3, '3', 1, 39, 'JUANA DE ARCO', 'ejercito 2', 'comuna3');
 
INSERT INTO personas (rut, dv, cantidad_choques, edad, nombre, direccion, comuna) values (4, '4', 1, 32, 'MARIA MONTT', 'ejercito 1', 'comuna4');
